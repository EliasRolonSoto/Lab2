...
import java.io.*;
public class Copiar implements Serializable {
    public static void main(String[] args) throws Exception{
        int contador_de_byte = 0;
        int datos_entrada[] = new int [363];

        try{    
            FileInputStream archivo_lectura = new FileInputStream("C:/Users/ezeca/Desktop/Archivo2.txt");
    ...
    static void crea_fichero (int datos_nuevo[]){
        try{
            FileOutputStream fichero_nuevo = new FileOutputStream("C:/Users/ezeca/Desktop/Archivo2_copia.txt");
